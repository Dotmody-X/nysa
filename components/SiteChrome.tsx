  ...
  return (
    <>
      {config.announcement.active && config.announcement.text && (
        <div style={{ padding: '10px 18px', background: 'var(--accent-budget)', color: 'var(--chocolate)', borderBottom: '1px solid var(--border)', ...DF, fontWeight: 700, fontSize: 12, textAlign: 'center' }}>
