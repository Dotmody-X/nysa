  ...
  return (
    <>
      {config.announcement.active && config.announcement.text && (
        <div style={{ padding: '10px 18px', background: 'var(--accent-brand)', color: 'var(--on-accent)', borderBottom: '2px solid var(--ink)', ...DF, fontWeight: 700, fontSize: 12, textAlign: 'center' }}>
