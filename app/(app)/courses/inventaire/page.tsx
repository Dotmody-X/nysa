    ...
    <div style={{ padding: 30, minHeight: '100%' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20, flexWrap: 'wrap' }}>
        ...
        <button onClick={() => setEditItem('new')} className="nb-press"
          style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '9px 16px', borderRadius: 'var(--radius-lg)', background: TEAL_BG, border: '2px solid var(--ink)', boxShadow: '4px 4px 0 var(--ink)', cursor: 'pointer', color: 'var(--ink-light)', ...DF, fontWeight: 800, fontSize: 12 }}>
