      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 30, flexWrap: 'wrap' }}>
        ...
        <button onClick={() => router.push(`/recettes/${id}/edit`)} className="nb-press"
          style={{
            ...
            background: ORANGE, color: 'var(--on-accent)', border: '2px solid var(--ink)', boxShadow: '4px 4px 0 var(--ink)', cursor: 'pointer', fontWeight: 700
          }}>
          ...
          <div style={{ ...card(), padding: 16, marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
              <button onClick={() => setServings(Math.max(1, servings - 1))}
                style={{
                  width: 36, height: 36, borderRadius: 8, background: ORANGE, color: 'var(--on-accent)',
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            <button onClick={() => setShowSchedule(true)} className="nb-press"
              style={{
                flex: 1, minWidth: 180, padding: '14px', borderRadius: 'var(--radius-lg)', background: ORANGE, color: 'var(--on-accent)',
            ...
            <button onClick={handleCooked} className="nb-press"
              style={{
                flex: 1, minWidth: 180, padding: '14px', borderRadius: 'var(--radius-lg)', background: '#5B9F3A', color: 'var(--ink-light)',
                border: '2px solid var(--ink)', boxShadow: '4px 4px 0 var(--ink)', cursor: 'pointer', fontWeight: 700, display: 'flex', alignItems: 'center',
                justifyContent: 'center', gap: 8, fontSize: 14
              }}>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              <button onClick={handleSchedule} className="nb-press"
                style={{
                  ...
                  color: 'var(--on-accent)', border: '2px solid var(--ink)', boxShadow: '4px 4px 0 var(--ink)', cursor: 'pointer', fontWeight: 700
                }}>
                Ajouter
              </button>
