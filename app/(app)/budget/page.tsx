...
const DARK    = 'var(--bg)'
const PALETTE = ['var(--accent-budget)','var(--azul)','#E8A838','#7C6FAF','#3ABCB8','#E46A45','#9B72CF','#C45E3E','#5E9C8F','#E8C84A']
...
export default function BudgetPage() {
  ...
  const PanelAI = (
    <div style={{ padding:'20px 24px', display:'flex', flexDirection:'column', gap:16 }}>
      <div style={{ background:TEAL_BG, borderRadius:12, padding:'16px 18px', display:'flex', gap:12, alignItems:'flex-start', '--text-rgb':'255, 255, 255', '--text':'#ffffff', '--text-muted':'rgba(255, 255, 255, 0.72)' } as React.CSSProperties}>
        ...
        <div style={{ ...CARD, gridColumn:'2/5', gridRow:'2/3' }}>
          ...
          <div style={{ flex:1, padding:'14px 20px', display:'flex', gap:16, overflow:'hidden' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:8, justifyContent:'center', flexShrink:0, width:130 }}>
              ...
              <div style={{ padding:'10px 14px', borderRadius:10, background:TEAL_BG, '--text-rgb':'255, 255, 255', '--text':'#ffffff', '--text-muted':'rgba(255, 255, 255, 0.72)' } as React.CSSProperties}>
