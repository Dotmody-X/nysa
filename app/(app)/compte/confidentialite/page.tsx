...
function PrivacyRow({ icon: Icon, label, sub, value, onChange }: {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 0', borderBottom: '1px solid var(--border)' }}>
      <div style={{ width: 36, height: 36, borderRadius: 10, background: 'var(--bg-input)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, border: '1px solid var(--border)' }}>
      ...
      <button onClick={() => onChange(!value)} className="nb-press"
        style={{ width: 42, height: 24, borderRadius: 99, background: value ? TEAL : 'var(--bg-input)', border: '1px solid var(--border)', boxShadow: 'var(--elev-1)', cursor: 'pointer', position: 'relative', transition: 'background 0.2s', flexShrink: 0 }}>
...
export default function ConfidentialitePage() {
  ...
  return (
    <div style={{ padding: '28px 32px', maxWidth: 600, margin: '0 auto' }}>
      ...
      {/* Privacy toggles */}
      <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', boxShadow: 'var(--elev-1)', borderRadius: 'var(--radius-lg)', padding: '4px 20px 4px', marginBottom: 12 }}>
      ...
      {/* Info block */}
      <div style={{ padding: '14px 16px', borderRadius: 'var(--radius-lg)', background: 'rgba(14,149,148,0.08)', border: '1px solid var(--border)', boxShadow: 'var(--elev-1)', display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 12 }}>
      ...
      <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', boxShadow: 'var(--elev-1)', borderRadius: 'var(--radius-lg)', padding: 20 }}>
        ...
        <button onClick={() => setShowDelete(true)} className="nb-press"
          style={{ width: '100%', background: ORANGE, color: 'var(--chocolate)', borderRadius: 'var(--radius-lg)', padding: '9px 0', ...DF, fontWeight: 700, fontSize: 12, border: '1px solid var(--border)', boxShadow: 'var(--elev-1)', cursor: 'pointer' }}>
      ...
      {showDelete && (
        <>
          ...
          <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', zIndex: 201, background: 'var(--bg-card)', borderRadius: 'var(--radius-xl)', padding: 28, width: 400, border: '1px solid var(--border)', boxShadow: 'var(--elev-1)' }}>
