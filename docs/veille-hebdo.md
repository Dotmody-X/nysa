...
**Radar → Veille Mixologue / Veille Aeterna**. Ce fichier décrit ce que la
...
|---|---|---|---|
| Le Mixologue | Lois sur la cigarette électronique en BE, FR, LU, CH, IT (+ UE), marché, tendances | `Le Mixologue` | `veille_mixologue` |
...
```sql
select work.deposer_veille('<user_id>', 'Le Mixologue', '[
  {
    "category": "loi",
    "country": "BE",
    "title": "Interdiction des puffs jetables confirmée par arrêté royal",
    "summary": "Deux phrases : ce qui change, et ce que ça implique pour la marque.",
...
values (
  ...
  '{
    "v": 1,
    "date": "2026-09-21",
    "title": "Veille Mixologue — semaine du 21/09",
    ...
    "flags": [
      { "tone": "danger", "text": "La France interdit ... au 1er janvier : vérifier la gamme." }
    ],
    "sections": [
      ...
      { "icon": "alert-triangle", "title": "Ce qui menace la marque","items": [ { "text": "..." } ] },
...
- Le journal filtrable par catégorie (et par pays pour le Mixologue), groupé par
  semaine de dépôt.
...
> Tu es la veille hebdomadaire du Mixologue, marque belge d'e-liquides
> distribuée en Belgique, France, Suisse et Luxembourg. Cherche sur le web ce
> qui a changé **depuis lundi dernier** sur : (1) la réglementation de la cigarette électronique et des
...
> avec `work.deposer_veille('<user_id>', 'Le Mixologue', [...])`, puis le récit
> de la semaine dans `work.digests` avec `kind = 'veille_mixologue'`. Dans le
> récit, dis ce que ça implique pour la marque, et termine par trois
> choses à faire.
